...
import { AddUser } from "../dashboard/AddTransformer";
        ...
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            <NavLink className="nav-link" to="/cables">
              ...
              <span className="nav-link-text ms-1">Cables</span>
            </NavLink>
            
          </li>
          <li className="nav-item">
            <NavLink className="nav-link" to="/manholes">
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg
                  width="12px"
                  height="12px"
              ...
              <span className="nav-link-text ms-1">Manholes</span>
            </NavLink>
