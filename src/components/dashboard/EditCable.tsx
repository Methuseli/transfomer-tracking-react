...
export default function EditCable({ setReload, record }: any) {
    ...
    const handleSubmit = (event: any) => {
        ...
        axios
            .patch(
                `${process.env.REACT_APP_BASE_URL}${process.env.REACT_APP_API_VERSION}cables/${record.id}/`,
                payload,
                {
                    headers: {
            ...
            .then((res) => {
                if (res.status === 200) {
                    setTimeout(() => {
                        ...
                        setReload(true);
                        toast({
                            title: "Successfully edited cable",
                            status: "success",
                            isClosable: true,
                        });
                    }, 500);
            ...
            .catch((err) => {
                console.log(err);
                setTimeout(() => {
                    setError("Failed to update cable");
                    setLoading(false);
                }, 500);
            });
    };
