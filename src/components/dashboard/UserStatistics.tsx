              ...
              <div className="col-lg-5 mb-lg-0 mb-4">
                <div className="card z-index-2">
                  <div className="card-body p-3">
                    ...
                    <h6 className="ms-2 mt-4 mb-0"> Active Subscribers </h6>
                      ...
                      <div className="row">
                        <div className="col-3 py-3 ps-0">
                          <div className="d-flex mb-2">
                            ...
                            <p className="text-xs mt-1 mb-0 font-weight-bold">Followers</p>
                          </div>
                        ...
                        <div className="col-3 py-3 ps-0">
                          <div className="d-flex mb-2">
                            ...
                            <p className="text-xs mt-1 mb-0 font-weight-bold">Subscribers</p>
                          </div>
                        ...
                        <div className="col-3 py-3 ps-0">
                          <div className="d-flex mb-2">
                            ...
                            <p className="text-xs mt-1 mb-0 font-weight-bold">Trades</p>
                          </div>
                        ...
                        <div className="col-3 py-3 ps-0">
                          <div className="d-flex mb-2">
                            ...
                            <p className="text-xs mt-1 mb-0 font-weight-bold">Signals</p>
                          </div>
