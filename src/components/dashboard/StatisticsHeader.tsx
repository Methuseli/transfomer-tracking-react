            ...
            <div className="row">
                            ...
                            <div className="row">
                                <div className="col-8">
                                    <div className="numbers">
                                        <p className="text-sm mb-0 text-capitalize font-weight-bold">My Websites</p>
                ...
                <div className="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    ...
                    <div className="card-body p-3">
                        ...
                        <div className="col-8">
                            <div className="numbers">
                            <p className="text-sm mb-0 text-capitalize font-weight-bold">Total Survey Takers</p>
                            <h5 className="font-weight-bolder mb-0">
                                {data.total_surveys}
                            </h5>
                            </div>
                ...
                <div className="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    ...
                    <div className="card-body p-3">
                        ...
                        <div className="col-8">
                            <div className="numbers">
                            <p className="text-sm mb-0 text-capitalize font-weight-bold">New Survey Takers</p>
                            <h5 className="font-weight-bolder mb-0">
                                {data.surveys_today}
                            </h5>
                        </div>
                ...
                <div className="card">
                    ...
                    <div className="row">
                        <div className="col-8">
                        <div className="numbers">
                            <p className="text-sm mb-0 text-capitalize font-weight-bold">Total System Users</p>
                            <h5 className="font-weight-bolder mb-0">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="d-flex flex-column h-100">
                                        ...
                                        <h5 className="font-weight-bolder">Probable Trible Dashboard</h5>
                                        <p className="mb-5">Monitor all your website users in one dashboard, add more webistes and link it to our extension for conducting surveys...</p>
                    ...
                    <div className="card h-100 p-3">
                        ...
                        >
                            ...
                            <div className="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                                <h5 className="text-white font-weight-bolder mb-4 pt-2">Extension Monitor</h5>
                                <p className="text-white">Get feedback on how your website performs from your daily user...</p>
